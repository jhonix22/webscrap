...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__search_service__ = __webpack_require__(400);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.searchJob = function (job_title, country) {
        var _this = this;
        var text;
        if (job_title && country) {
            this.searchService
                .searchJob(job_title, country)
                .subscribe(function (data) { _this.content = data; });
        }
    };
...
var SearchService = (function () {
    ...
    SearchService.prototype.searchJob = function (job_title, country) {
